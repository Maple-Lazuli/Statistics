...
$p\_value = P(T_{10, 0.025} >|$ `r t`$|) =$ `r 1 - pt(t, df)`
...
$p\_value = P(F_{3,126, 0.025} >|$ `r f_value`$|) =$ `r 1 - pf(f_value, df1 =df1, df2 = df2)`
...
`r f_value` > `r qf(alpha, df1 = df1, df2 = df2)`

```{r}
f_value < qf(alpha, df1 = df1, df2 = df2)
```

Is the p-value less than $\alpha$?

`r 1 - pf(f_value, df1 =df1, df2 = df2)` < `r alpha`

```{r}
1 - pf(f_value, df1 =df1, df2 = df2) < alpha 
```
